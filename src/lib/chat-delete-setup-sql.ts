...
export const CHAT_DELETE_SETUP_SQL = `-- OfficeEx: enable chat delete / remove (run once in Supabase SQL Editor)
...
export const CHAT_DELETE_SQL_EDITOR_URL =
  'https://supabase.com/dashboard/project/mrspndxusvczftygqjez/sql/new';

export const CHAT_DELETE_NOT_SETUP_MESSAGE =
  'Chat delete is not enabled on Supabase yet. Settings → Supabase Chat Setup → Copy SQL → paste in Supabase SQL Editor → Run → reload this app.';
